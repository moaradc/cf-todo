    ...
    <div style="flex:1; overflow-y:auto; padding-bottom: 20px;">
      ...
      <div class="settings-card">
          ...
          <div class="setting-item" style="margin-bottom: 4px; border: none; padding: 0;">
              ...
              <div class="fake-input" onclick="toggleSettingPopover('reminderTz', this)" style="width: 50px; margin-bottom: 0; padding: 6px 10px; justify-content: space-between; border-radius: 4px;">
