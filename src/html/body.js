    ...
    <div style="flex:1; overflow-y:auto; padding-bottom: 20px;">
      ...
      <div class="settings-card">
          ...
          <div style="display:flex; gap:6px; align-items:center; margin-bottom: 12px;">
              <div class="fake-input" onclick="openReminderSkipPicker('start')" style="width: 80px; margin-bottom: 0; padding: 6px 10px; justify-content: space-between; border-radius: 4px;">
              ...
              <div class="fake-input" onclick="openReminderSkipPicker('end')" style="width: 80px; margin-bottom: 0; padding: 6px 10px; justify-content: space-between; border-radius: 4px;">
          ...
          <div style="border-top: 1px dashed #333; margin: 10px 0; padding-top: 10px;">
            <div class="detail-label">提醒模式</div>
          ...
          <div style="border-top: 1px dashed #333; margin: 10px 0; padding-top: 10px;">
            ...
            <div style="border: 1px dashed #5a3a3a; margin: 14px 0 4px 0; padding: 10px 12px; border-radius: 4px;">
              ...
              <div id="precise-cleanup-status" style="font-size:0.7rem; color:#888; min-height:0;"></div>
            </div>
          </div>
          ...
          <div class="settings-text" style="border-top: 1px dashed #333; padding-top: 10px; margin-top: 0;">
            <strong>使用方式：</strong>前往 <a href="https://resend.com/api-keys" target="_blank" style="color: var(--accent); text-decoration: none;">Resend</a> 添加自备域名，创建 API Key → 在 GitHub 或 Cloudflare 添加 RESEND_API_KEY → 填写收发件邮箱 → 启用定时提醒 → 保存配置。
          </div>
      </div>
