...
/* ── reminder (邮件通知设置) ── */
.reminder-mode-block{background:var(--ycy-panel)!important;border:1px solid var(--ycy-bd)!important;border-radius:var(--ycy-r-s)!important;box-shadow:var(--ycy-sh)!important}
.reminder-mode-title{color:var(--ycy-t)!important}
...
.reminder-pill{color:var(--ycy-t2)!important;background:transparent!important;border:1px solid var(--ycy-bd)!important;box-shadow:none!important;transition:transform .1s!important}
...
.weekday-chip{color:var(--ycy-t2)!important;background:transparent!important;border:1px solid var(--ycy-bd)!important;box-shadow:none!important;transition:transform .1s!important}
...
[data-theme="light"] .reminder-pill,[data-theme="light"] .weekday-chip{border-color:rgba(0,0,0,.15)!important}
</style>
```
</details>
